...
function hideFacilityNotification(facilityId, contentHash) {
    let cookieName = 'hideFacilityNotification_'+ facilityId;
    let cookieValue = getCookie(cookieName);

    if (cookieValue !== null && cookieValue !== "true" /*old cookies stored true*/) {
        cookieValue += ",";
    } else {
        cookieValue = "";
    }

    cookieValue += contentHash;
    setCookie(cookieName, cookieValue, 2100, 1, 1);
}
...
function cookieValueEqual(cookie_name, expected) {
